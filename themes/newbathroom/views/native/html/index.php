                                 ...
                                 <ul class="categories">
                                     <li class="first">
                                         ...
                                         <ul class="categories">
                                             <li class="first">
                                                 <a href="#">
                                                     <span>Плитка напольная</span>
                                                 </a>
                                             </li>
                                             <li>
                                                 <a href="#">
                                                     <span>Плитка настенная</span>
                                                 </a>
                                             </li>
                                             <li>
                                                 <a href="#">
                                     ...
                                     <li>
                                         ...
                                         <ul class="categories">
                                             <li class="first">
                                                 <a href="#">
                                                     <span>Компакты, унитазы, уриналы</span>
                                                 </a>
                                             </li>
                                             <li>
                                                 <a href="#">
                                             ...
                                             <li>
                                                 <a href="#">
                                                     <span>Гидромассажные боксы</span>
                                                 </a>
                                             </li>
                                             <li>
                                                 <a href="#">
                                     ...
                                     <li>
                                         ...
                                         <ul class="categories">
                                             ...
                                             <li>
                                                 <a href="#">
                                                     <span>Металлопластиковая труба</span>
                                                 </a>
                                             </li>
                                             <li>
                                                 <a href="#">
