...
class NS {
	 ...
	 *
	 *     $foo = NS::extract_namespace('CMS3\Test\Foo');
	 *     Значение $foo: 'CMS3\Test'
	 *     
	 ...
	 *
	 *     $foo = NS::extract_class_name('CMS3\Test\Foo');
	 *     Значение $foo: 'Foo'
	 *     
	 * @param   string|object	$class
	 * @return  string
	 ...
	 *
	 *     $foo = NS::extract_module_name('CMS3\Test\Foo');
	 *     Значение $foo: 'Test'
	 *     
	 * @param   string|object	$class
	 * @return  string
	 ...
	 * пространства имен
	 *
	 *     $foo = NS::add_class_prefix('CMS3\Test\Foo', 'Class_');
	 *     Значение $foo: 'CMS3\Test\Class_Foo'
	 *     
	 * @param   string|object	$class
	 * @param   string			$prefix
	 * @return  string
