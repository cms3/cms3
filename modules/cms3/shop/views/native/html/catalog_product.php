<ins class="item">
	<div class="brace">
		...
		?>
		<ins class="img-block">
			<a href="/shop/?shop.product.id=<?php echo $this->product['id'] ?>" class="drag-obj"><img width="<?php echo $this->product['default_image']['thumbnail']['width'] ?>" height="<?php echo $this->product['default_image']['thumbnail']['height'] ?>" src="<?php echo $this->product['default_image']['thumbnail']['url'] ?>" alt="<?php echo $this->product['title'] ?>" /></a><br />
		</ins>
		<div class="caption">
			<?php
			...
			?>
			<h3 class="title"><a href="/shop/?shop.product.id=<?php echo $this->product['id'] ?>"><?php echo $this->product['title'] ?></a></h3>
