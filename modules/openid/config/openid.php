 ...
 *
 * $Id: openid.php 82 2008-09-25 17:28:07 BST Atomless $
 *
...
'return_to' => 'http://example.com/openid/complete_authentication/',
...
'user_attributes_required' => array
(
	'fullname',
	'email'
),
...
// For list of commonly supported attributes see: Openid_Extension_Sreg::$supported_user_attribute_fields
'user_attributes_optional' => array
(
	'nickname',
	'language',
	'country',
...
(
	...
	(
		...
		'update_url' => 'http://example.com/openid/verify_response/'
	),
...
'session_name' => 'kohana_openid_session',
