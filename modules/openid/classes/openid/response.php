 ...
 *
 * $Id: response.php 2008-09-25 17:28:07 BST Atomless $
 *
 ...
 */
abstract class Openid_Response extends Openid_Association {
...
*/
	 ...
	 * This is used instead of the to_string method of the kvf helper to convert
	...
	{
		$current_url_components = @parse_url('http://' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]); // TODO
	...
	protected function request_sig_verification_from_openid_provider()
	{
		...
		$KVF_post_data = kvf::associative_array_to_string($fields_to_post);
