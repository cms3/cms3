 ...
 *
 * $Id: ax.php 2008-09-25 17:28:07 BST Atomless $
 *
 ...
 */
class Openid_Extension_Ax {

	const AX_NAMESPACE = 'http://openid.net/srv/ax/1.0';

	const NAMESPACE_ALIAS = 'ax';

	public static $supported_namespaces = array
	(
		Openid_Extension_Ax::AX_NAMESPACE
	);
	...
	(
		'ns'           => Openid_Extension_Ax::AX_NAMESPACE,
