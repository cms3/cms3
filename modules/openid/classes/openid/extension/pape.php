 ...
 *
 * $Id: pape.php 2008-09-25 17:28:07 BST Atomless $
 *
 * @package    Openid
 * @author     Kohana Team
 ...
 */
class Openid_Extension_Pape {

	// Namespaces
	const SREG_NAMESPACE = 'http://specs.openid.net/extensions/pape/1.0';

	const NAMESPACE_ALIAS = 'pape';

	public static $supported_namespaces = array
	(
		Openid_Extension_Pape::SREG_NAMESPACE
	);
	...
	(
		'ns' => Openid_Extension_PAPE::SREG_NAMESPACE,
