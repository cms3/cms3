...
abstract class Openid_Core {
	...
	(
		...
		// Verbatum copy of the id submitted by the user in the openid_identifier form
	...
	*/
	...
	protected function add_attribute_extension($required_fields, $optional_fields)
	{
		...
		{
			$this->log('error', 'Openid', 'add_attribute_extension', KOHANA::debug($e), array_merge($required_fields, $optional_fields));
		}
	...
	*/
	protected function get_required_fields()
	{
		...
		else
		{
			...
			{
				$required_fields = Openid_arr::linear_remove($required_fields, array('assoc_handle'));
			}
		}
