 ...
 *
 * $Id: relyingparty.php 2008-09-25 17:28:07 BST Atomless $
 *
 ...
 */
abstract class Openid_Relyingparty extends Openid_Response {
	...
	*/
	public function start_authentication($claimed_id = FALSE, $request_attributes = FALSE)
	{
		...
		if ($this->claimed_id === '')
		{
			$this->log('authentication_error', 'Openid_Relyingparty', 'start_authentication');
