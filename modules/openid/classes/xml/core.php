 ...
 *
 * $Id: xml.php 2008-09-25 17:28:07 BST Atomless $
 *
 * @package    Openid
 * @author     Kohana Team
...
class XML_Core {
	...
	public function load($xml_string, $namespace_map = array())
	{
		if (is_string($xml_string))
		{
			...
			$this->simplexml = (is_file($xml_string) OR Validate::url($xml_string))? simplexml_load_file($xml_string) : simplexml_load_string($xml_string);
