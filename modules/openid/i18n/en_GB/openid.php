...
(
	...
	(
		...
		'length'   => 'This username must be between 4 and 20 characters.',
		'exists'   => 'Sorry, this username is not available.',
	...
	(
		...
		'default'                   => 'Error locating provider for this openID please check and try again.'
	),

	'database'						=> array
	(
		'field_not_found'			=> 'Error! Field not found in db. %s'
	),
